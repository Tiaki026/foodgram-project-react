...
# Содержание
- [## :page_with_curl: Описание](## :page_with_curl: Описание)
- [## :chart_with_upwards_trend: Процесс разработки, особенности и трудности](## :chart_with_upwards_trend: Процесс разработки, особенности и трудности)
- [## :computer: Стек технологий](## :computer: Стек технологий)
