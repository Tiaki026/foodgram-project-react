...
В users - модели и админка пользователей и подписок. Решил вынести их отдельно от рецептов, так как пользователи связаны с регистрацией и аутентификацией, а подписки связаны с пользователями.
